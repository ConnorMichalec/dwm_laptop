...
static Key keys[] = {
	...
	{ MODKEY,		                XK_c,      setlayout,      {.v = &layouts[2]} }, //centered master
	...
	{ MODKEY|Mod4Mask,  			XK_comma,  tagswapmon,     {.i = +1 } },
	{ MODKEY|Mod4Mask,			    XK_period, tagswapmon,     {.i = -1 } },
